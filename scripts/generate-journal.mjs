...
# あんBBQ（An BBQ / ニューバーベキュー）の思想 — 正本 bbq-site/AN-BBQ-PHILOSOPHY.md の凝縮
- アメリカンBBQの優れたロジック（蓋付きグリル・間接熱・ロー&スロー・温度の科学）は継承する。ただし12時間級の長時間燻製は日本の暮らしに根づかない。その限界を超えて日常に溶け込む新概念が「あんBBQ」。
...
- どちらの系統でも、温度の科学・道具のロジックという土台は共通。全部をあんBBQに寄せず、入口記事の役割も大切にする。
